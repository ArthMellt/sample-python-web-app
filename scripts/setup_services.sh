#!/bin/bash -xe
##Install uWSGI as a system service, enable it to run at boot, then start it
...
##Copy the nginx config file, then ensure the nginx starts at boot, and restart it to load the config
